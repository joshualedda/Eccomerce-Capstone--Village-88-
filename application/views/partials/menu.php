		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 my-auto d-flex align-items-center justify-content-center">
					<h5 class="brand-name mb-0"><a href="<?= base_url('catalogs') ?>"
							class="text-decoration-none text-dark text-muted">VeggieCart</a></h5>
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<?php if (isset($role) && $role == 1): ?>
										...
										<li><a class="dropdown-item" href="<?= base_url('dashboard') ?>"> <i
													class="fa fa-pie-chart" aria-hidden="true"></i> Dashboard</a></li>
									<?php else: ?>
										<li><a class="dropdown-item" href="<?= base_url('account/profile') ?>"><i
													class="fa fa-user"></i> Profile</a></li>

									<?php endif; ?>


									<li><a class="dropdown-item" href="<?= base_url('orders/track') ?>"><i
												class="fa fa-list"></i> My Orders</a></li>
									<li><a class="dropdown-item" href="<?= base_url('account/profile') ?>"><i
												class="fa fa-heart"></i> My Wishlist</a></li>
									<li><a class="dropdown-item" href="<?= base_url('carts') ?>"><i
