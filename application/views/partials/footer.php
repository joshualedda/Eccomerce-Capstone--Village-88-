<script src="<?=base_url('assets/js/cartsPayValidation') ?>"></script>
...
<script src="<?=base_url('assets/js/category') ?>"></script>
<script src="<?=base_url('assets/js/orders') ?>"></script>
<!-- chart js -->
<script src="<?=base_url('assets/chart/chart.umd') ?>"> </script>
<script src="<?=base_url('assets/js/charts') ?>"> </script>
